...
import { User, X, MapPin, Mail } from "lucide-react";
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    {client.map((profile) => (
                        ...
                        >
                            ...
                            {/* Action Bar */}
                            <div className=" pt-4 border-t border-gray-100 mt-auto mb-2 gap-2">
                                <button
                                    onClick={() => handleProfileView(profile._id)}
                                    className="bg-green-500 text-white px-3 py-2 rounded-lg text-sm font-medium hover:bg-green-600 transition-colors duration-200 flex items-center justify-center w-full text-center"
                                >
                                    <User size={16} />
                                    <span>Profile</span>
                                </button>
                                ...
                                {/* <button
                                    ...
                                    className="bg-green-500 text-white px-3 py-2 rounded-lg text-sm font-medium hover:bg-green-600 transition-colors duration-200 flex items-center space-x-2"
                                >
                                    <MessageCircle size={16} />
                                    <span>Message</span>
                                </button> */}
