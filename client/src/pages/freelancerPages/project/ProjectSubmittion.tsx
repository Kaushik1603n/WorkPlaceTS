...
import { Download, Upload, Clock, CheckCircle, AlertCircle, DollarSign } from 'lucide-react';
...
const MilestonesDeliverables: React.FC = () => {
  const [milestones] = useState<Milestone[]>([
    { id: 1, title: 'Draft Design', dueDate: 'May 10, 2025', amount: 500, status: 'in-progress' },
    { id: 2, title: 'Development', dueDate: 'May 20, 2025', amount: 1000, status: 'pending' },
    { id: 3, title: 'Final Delivery', dueDate: 'May 30, 2025', amount: 500, status: 'pending' }
  ]);
