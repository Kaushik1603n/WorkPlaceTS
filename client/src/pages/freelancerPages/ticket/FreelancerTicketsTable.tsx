import type { Status,Ticket } from '../../../components/client/ticket/types';
...
function FreelancerTicketsTable({ tickets }: ClientTicketsTableProps) {
    return (
                     ...
                     <tbody className="bg-white divide-y divide-gray-200">
                         {tickets.map((ticket) => (
                             <tr key={ticket._id} className="hover:bg-gray-50">
                                 ...
                                 <td className="px-6 py-4 whitespace-nowrap">
                                     <div className="text-sm text-gray-900">{ticket.client.id || 'Client'}</div>
                                 </td>
                                 <td className="px-6 py-4 whitespace-nowrap">
...
export default FreelancerTicketsTable
